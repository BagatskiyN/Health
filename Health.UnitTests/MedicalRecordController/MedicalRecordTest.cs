    ...
    public class MedicalRecordTest
    {
        ...
        public void Initialize()
        {
            ...
            mock1.Setup(m => m.Get()).Returns(new List<Doctor>
               {
                 new Doctor(){DoctorId=1,DoctorName="Сергей",DoctorSurname="Аксенов",DoctorPatronymic="Валентинович",DoctorPhone="32423432",SpecializationId=1 },
                 ...
                 new Doctor(){DoctorId=3,DoctorName="Светлана",DoctorSurname="Римова",DoctorPatronymic="Оксановна",DoctorPhone="43242432",SpecializationId=3 },
